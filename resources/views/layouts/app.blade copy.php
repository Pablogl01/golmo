...
<body>
    <div id="app">
        <nav class="navbar navbar-expand ">
            <div class="d-flex flex-row justify-content-arround" style="padding:0; width:100%">
            <a style="margin-right:75%; margin-left:15px" class="navbar-brand" href="{{ url('/') }}">
                <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
                width="70pt" height="54.000000pt" viewBox="0 0 367.000000 54.000000"
                ...
                <div class="d-flex align-items-center" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            ...
                            @endif
                        @else
                        <a href="{{route('profile')}}" style="color:black;">CUENTA GOLMO</a>
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="navbar-brand" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <svg height="10pt" viewBox="0 -53 384 384" width="10pt" xmlns="http://www.w3.org/2000/svg"><path d="m368 154.667969h-352c-8.832031 0-16-7.167969-16-16s7.167969-16 16-16h352c8.832031 0 16 7.167969 16 16s-7.167969 16-16 16zm0 0"/><path d="m368 32h-352c-8.832031 0-16-7.167969-16-16s7.167969-16 16-16h352c8.832031 0 16 7.167969 16 16s-7.167969 16-16 16zm0 0"/><path d="m368 277.332031h-352c-8.832031 0-16-7.167969-16-16s7.167969-16 16-16h352c8.832031 0 16 7.167969 16 16s-7.167969 16-16 16zm0 0"/></svg>
                                </a>
