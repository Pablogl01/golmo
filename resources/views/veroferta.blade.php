                    ...
                    <div style="margin-left:10%;margin-right:10%;padding-top:25px;">
                        ...
                        @if($oferta->type==1)
                            <div style="display:flex;flex-direction:row;width:50%;align-items:center;">
                                <input type="radio" name="tipo_s" value="1" checked>
                        ...
                        @else
                            <div style="display:flex;flex-direction:row;width:50%;align-items:center;">
                                    <input type="radio" name="tipo_s" value="1">
                                <label style="margin:0;margin-left:10px;">Oferta comercial</label>
                            </div>
                            <div style="display:flex;flex-direction:row;width:50%;align-items:center;">
                                <input type="radio" name="tipo_s" value="2" checked>
                                <label style="margin:0;margin-left:10px;">Prueba de conducción</label>
                            </div>
                        @endif
                        </div>
                        <div class="divcontenedorofertas" style="display:flex;flex-direction:row;width:75%;margin-top:15px;">
                            ...
                            <div style="display:flex;flex-direction:column;width:45%;margin-right:5%;">
                                ...
                                <input style="padding:0 !important; width:100%; margin-bottom:15px; border-right:none; border-top:none; border-left:none; border-bottom:1px solid #C6C6C6;background-color:transparent; outline:none; color:#4E4E4E; caret-color:#939393;font-size:18px;border-radius:0 !important;" type="text" name="email" value="{{$user->email}}" disabled>
                            </div>
                        </div>
                        <div class="divcontenedorofertas" style="display:flex;flex-direction:row;width:75%;margin-top:15px;">
                            <div style="display:flex;flex-direction:column;width:45%;margin-right:5%;">
                                ...
                                <input style="padding:0 !important; width:100%; margin-bottom:15px; border-right:none; border-top:none; border-left:none; border-bottom:1px solid #C6C6C6;background-color:transparent; outline:none; color:#4E4E4E; caret-color:#939393;font-size:18px;border-radius:0 !important;" type="date" name="birthdate" value="{{$user->birthdate}}" disabled>
                            </div>
                            <div style="display:flex;flex-direction:column;width:45%;margin-right:5%;">
                                ...
                                <input style="width:100%; margin-bottom:15px; border-right:none; border-top:none; border-left:none; border-bottom:1px solid #C6C6C6;background-color:transparent; outline:none; color:#4E4E4E; caret-color:#939393;font-size:18px;border-radius:0 !important;" type="text" name="phonenumber" value="{{$user->phone_number}}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="divcontenedorofertas" style="margin-top:15px;display:flex;flex-direction:column;width:45%;margin-right:5%;">
                            ...
                            <select name="modelo" style="padding:0 !important; width:100%; margin-bottom:15px; border-right:none; border-top:none; border-left:none; border-bottom:1px solid #C6C6C6;background-color:transparent; outline:none; color:#4E4E4E; caret-color:#939393;font-size:18px;border-radius:0 !important;" disabled>
                                <option value="{{$carmodel}}">{{$carmodel}}</option>
                            </select>
                        </div>
                        <div style="display:flex;flex-direction:row;align-items:center;">
                            <input type="checkbox" name="protect" checked>
                        ...
                        <div style="margin-top:15px;display:flex;flex-direction:row;justify-content:center;align-items:center;width:45%;">
                            @if($me == 2)
                            <a id="button" href="{{route('misofertas')}}" style="text-decoration:none;text-align:center;padding-top:5px;padding-bottom:5px;width:100%; margin-bottom:5px; border:1px solid #7C7C7C;background-color:transparent; outline:none;font-size:15px;color:#7C7C7C;">Volver atrás</a>
                            @else
                            <a id="button" href="{{route('gestionofertas')}}" style="text-decoration:none;text-align:center;padding-top:5px;padding-bottom:5px;width:100%; margin-bottom:5px; border:1px solid #7C7C7C;background-color:transparent; outline:none;font-size:15px;color:#7C7C7C;">Volver atrás</a>
                            @endif
                        </div>
                    </div>
                </div>
