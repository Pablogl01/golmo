                ...
                <p class="h3 text-white" style="font-weight: bold;">Mis coches</p>
                    ...
                    <div style="background-color:white;min-height:calc(70vh - 65px - 53px);padding-top:5vh;padding-bottom:5vh;padding-left:3vw;padding-right:3vw;margin-bottom:5vh;">
                        ...
                        @if(count($ofertas)!=0)
                            ...
                            <div style="display:flex;flex-directionrow:justify-content-center:align-items:center:width:100%;">
                                <div class="d-flex flex-row divcontenedor2" style="padding-top:5px;width:23.33%;margin-right:3.33%">
                                @if($oferta->type==1)    
                                ...
                                <div class="d-flex flex-row divcontenedor2" style="padding-top:5px;width:23.33%;margin-left:3.33%;margin-right:3.33%">
                                ...
                                <div class="d-flex flex-row divcontenedor2" style="padding-top:5px;width:10%;margin-left:3.33%;">
                                    <a style="text-decoration:none;color:#292929;" href="{{route('veroferta',$oferta)}}">
                                        <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="20px" height="25px" viewBox="0 0 512.000000 512.000000" preserveAspectRatio="xMidYMid meet">
                                        <metadata>
